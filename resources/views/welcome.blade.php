...
<body class="bg-[#0d0d0d] text-[#f5f2ec] min-h-screen flex items-center justify-center px-6 py-16 font-mono">
    ...
    <main class="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 items-center">

        {{-- Left: Text --}}
        <div>
            <header class="mb-8">
                <p class="text-[#a855f7] text-xs tracking-widest uppercase mb-4">Ana Tavares</p>
                <h1 class="text-3xl font-bold leading-snug text-[#f5f2ec]">
            ...
            <section class="space-y-5 mb-10 text-sm text-zinc-400 leading-relaxed">
                <p>
                    Currently at Laravel,
                    <a href="https://www.laravel.com/blog" target="_blank" rel="noopener noreferrer" class="text-[#a855f7] hover:text-[#c084fc] transition-colors duration-150">running the blog</a>,
            ...
            <a
                ...
                class="inline-block border border-[#a855f7] text-[#a855f7] hover:bg-[#a855f7] hover:text-[#0d0d0d] font-medium text-xs tracking-widest uppercase px-6 py-3 transition-colors duration-150"
            >
                Connect on LinkedIn
            </a>
        </div>
